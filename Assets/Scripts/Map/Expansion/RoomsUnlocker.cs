...
public class RoomsUnlocker : UnityEngine.Object
{
    private Room[,] _rooms;
    ...
    public void ActivateNextRoom(Wall brakedWall)
    {
        ...
        int indexOfBrakedWall = Array.IndexOf(currentRoom.walls, brakedWall);
        ...
        if (nextRoom.Avaible)
            nextRoom.Activate(indexOfBrakedWallInNextRoom);
